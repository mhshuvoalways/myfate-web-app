...
const filePathsJapan = [
  ...
  path.join(__dirname, "japan/money/outlook.json"),
  path.join(__dirname, "japan/money/outlook2.json"),
  path.join(__dirname, "japan/money/overview.json"),
...
function processMultipleFiles(personalityType, userName, userGender, language) {
  ...
  return Promise.all(
    ...
    return {
      ...
      fullOverview: results[0].content,
      ...
      loveOverview: results[6].content,
      loveNeeds: results[7].content,
      loveLifeCycle: results[8].content,
      loveMarriage: results[9].content,
      loveKids: results[10].content,
      loveIdealPartner: results[11].content,
      financeOverview: results[12].content,
      financeOutlook: results[13].content,
      financeOutlook2: results[14].content,
      financeRisk: results[15].content,
      academicOverview: results[16].content,
      academicIdealCareer: results[17].content,
      academicLearning: results[18].content,
