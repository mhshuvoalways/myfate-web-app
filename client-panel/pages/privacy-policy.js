    ...
    <>
      ...
      <div>
        ...
        <div className="sm:max-w-[640px] w-full px-[30px] mx-auto my-20">
            <p>{`1. MyFates 개인정보 처리방침
“개인정보 처리방침”이란 이용자가 안심하고 서비스를 이용할 수 있도록 회사가 준수해야 할 지침을 의미하며, MyFates는 개인정보처리자가 준수하여야 하는 대한민국의 관계 법령 및 개인정보보호 규정, 가이드라인을 준수하여 개인정보 처리방침을 제공합니다.

MyFates는 이용자의 동의를 기반으로 개인정보를 수집·이용 및 제공하고 있습니다. 이용자의 권리(개인정보 자기결정권)를 적극적으로 보장하기 위해 개인정보 처리방침을 알기 쉽게 제공할 수 있도록 다양한 노력을 기울이고 있으며, 이러한 노력의 일환으로 MyFates의 주요 개인정보 처리 관련 정보를 라벨링으로 제공합니다.

MyFates 개인정보 처리방침은 MyFates Dashboard서비스를 포함하여 회사가 제공하는 MyFates 서비스(이하 ‘서비스'라 함)에 적용됩니다. 단, 특정 MyFates 서비스에서 개별적으로 개인정보 처리방침을 운영하는 경우 그에 따릅니다.
...
[MyFates계정 가입 시]필수
이메일, 비밀번호, 이름, 서비스 이용내역, 서비스 내 구매 및 결제 내역
선택
생년월일시, 성별, 배송지정보(수령인명, 배송지주소, 전화번호)
[유료서비스 이용 시]
...
*서비스 이용 내역이란 서비스 이용 과정에서 자동화된 방법으로 생성되거나 이용자가 입력한 정보가 송수신되면서 MyFates 서버에 자동으로 기록 및 수집될 수 있는 정보를 의미합니다. 이와 같은 정보는 다른 정보와의 결합 여부, 처리하는 방식 등에 따라 개인정보에 해당할 수 있고 개인정보에 해당하지 않을 수도 있습니다.


서비스 이용 내역에는 이용자가 입력 및 공유한 콘텐츠, 이용자가 입력한 검색어, 방문 및 접속기록, 서비스 부정이용 기록, 위치정보 등이 포함될 수 있습니다. 예를 들면, 이용자간 주고받은 메시지의 텍스트, 이미지, 동영상, 음성 등은 회사의 서버를 경유하여 상대방에게 송신됩니다. 이 때 콘텐츠 수신자, 데이터 형식, 게시 일시 등 이용자와 상대방과의 사이에서 송수신하는 형태, 방식 정보도 서버에 기록됩니다. MyFates는 이용자간 주고받은 메시지 등 전송하는 콘텐츠 내용은 원칙적으로 전송 이외의 목적으로는 사용하지 않습니다. MyFates는 서비스 이용기록 등의 정보를 서비스 제공 목적으로 처리할 수 있으며 필요한 경우에는 이용자의 추가 동의 등을 받고 이용할 수 있습니다.
...
수집 목적과 합리적으로 관련된 범위에서는 법령에 따라 이용자의 동의 없이 개인정보를 이용하거나 제3자에게 제공할 수 있습니다. 이때 ‘당초 수집 목적과 관련성이 있는지, 수집한 정황 또는 처리 관행에 비추어 볼 때 개인정보의 추가적인 이용 또는 제공에 대한 예측 가능성이 있는지, 이용자의 이익을 부당하게 침해하는지, 가명처리 또는 암호화 등 안전성 확보에 필요한 조치를 하였는지를 종합적으로 고려합니다.

MyFates는 수집한 개인정보를 특정 개인을 알아볼 수 없도록 가명처리하여 통계작성, 과학적 연구, 공익적 기록보존 등을 위하여 처리할 수 있습니다. 이 때 가명정보는 재식별되지 않도록 추가정보와 분리하여 별도 저장・관리하고 필요한 기술적・관리적 보호조치를 취합니다.

4. 개인정보 제공
MyFates는 이용자의 별도 동의가 있거나 법령에 규정된 경우를 제외하고는 이용자의 개인정보를 제3자에게 제공하지 않습니다.
MyFates는 이용자의 사전 동의 없이 개인정보를 제3자에게 제공하지 않습니다. 다만, 이용자가 MyFates계정 로그인 서비스를 이용하거나 외부 제휴사 등의 서비스를 이용하는 경우 필요한 범위 내에서 이용자의 동의를 얻은 후에 개인정보를 제3자에게 제공하고 있습니다. 
...
안내메일 발송 및 CS문의 대응을 위해 MyFates계정과 탈퇴안내 이메일 주소를 암호화하여 보관
서비스 부정이용 기록
2)권리침해 신고 및 유해정보 신고 이력은 5년간 보관 후 파기합니다.
또한, MyFates는 1년간 서비스를 이용하지 않은 이용자의 개인정보를 별도로 분리 보관 또는 삭제하고 있으며, 분리 보관된 개인정보는 4년간 보관 후 지체없이 파기합니다. 

이 외에 법령에 따라 일정기간 보관해야 하는 개인정보는 아래 표와 같습니다.

6. 개인위치정보의 처리
MyFates는 위치정보의 보호 및 이용 등에 관한 법률(이하 ‘위치정보법’)에 따라 아래와 같이 개인위치정보를 처리합니다.MyFates 위치정보 이용약관 제4조에 따른 서비스의 제공을 위해 개인위치정보를 보유할 수 있습니다.
...
MyFates는 이용자의 동의 없이 개인위치정보를 제3자에게 제공하지 않으며, 제3자에게 제공하는 경우에는 제공받는 자 및 제공목적을 사전에 이용자에게 고지하고 동의를 받습니다.
...
MyFates는 이용자의 요청을 받은 경우 이를 지체없이 처리하며, 이용자가 개인정보의 오류에 대한 정정을 요청한 경우 정정을 완료하기 전까지 해당 개인정보를 이용 또는 제공하지 않습니다.
...
8. 개인정보 자동 수집 장치에 관한 사항 (설치ㆍ운영 및 거부)
...
MyFates는 이용자의 개인정보 보호를 위해 아래의 노력을 합니다.
 이용자의 개인정보를 암호화하고 있습니다.
이용자의 개인정보를 암호화된 통신구간을 이용하여 전송하고, 비밀번호 등 중요정보는 암호화하여 보관하고 있습니다.
 해킹이나 컴퓨터 바이러스로부터 보호하기 위하여 노력하고 있습니다.
해킹이나 컴퓨터 바이러스 등에 의해 이용자의 개인정보가 유출되거나 훼손되는 것을 막기 위해24시간 감시하고 있으며, 백신 프로그램을 설치하여 시스템이 최신 악성코드나 바이러스에 감염되지 않도록 노력하고 있습니다. 또한 새로운 해킹/보안 기술에 대해 지속적으로 연구하여 서비스에 적용하고 있습니다.
...
MyFates는 유럽연합 일반 개인정보보호법(General Data Protection Regulation) 및 EU 회원국의 법률(이하 ‘GDPR 등’)을 준수합니다.
유럽연합 내 이용자를 대상으로 서비스를 제공하는 경우, 아래 내용이 적용될 수 있습니다.
[개인정보 처리의 목적 및 처리근거]
MyFates는 수집한 개인정보를 "3. 개인정보의 이용"에 기재된 목적으로만 이용하며, 사전에 이용자에게 해당 사실을 알리고 동의를 구하고 있습니다.
그리고 GDPR 등에 따라 MyFates는 아래 하나에 해당하는 경우에 이용자의 개인정보를 처리할 수 있습니다.
정보주체의 동의
...
또한, MyFates는 이벤트 및 광고 등 마케팅을 제공하기 위해 개인정보를 활용할 수 있으며, 사전에 이용자의 동의를 구하고 있습니다. 이용자는 원하지 않은 경우 언제든지 동의를 철회할 수 있습니다.
...
MyFates는 이용자의 개인정보 관련 문의사항 및 불만 처리 등을 위하여 개인정보 보호책임자 및 고충처리 부서를 지정하고 있습니다.개인정보 보호책임자 및 고충처리 부서
책임자: 김지연 (개인정보 보호책임자/CEO)
문의 
- MyFates 고객센터
...
 
개인정보보호책임자 & 고충처리 부서
MyFates 서비스 이용 시 발생하는 모든 개인정보보호 관련 문의 및 불만사항은 개인정보보호책임자 및 고충처리 부서(MyFates 고객센터)로 문의해주시면 됩니다.
...
MyFates는 이용자 여러분의 정보를 소중히 생각하며, 이용자가 더욱 안심하고 서비스를 이용할 수 있도록 최선의 노력을 다할 것을 약속드립니다.
공고일자: 2023년 12월 28일
시행일자: 2024년 01월 01일
`}</p>
          <br />
